...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2021 at 12:33 AM
...
INSERT INTO `911calls` (`call_id`, `caller_id`, `call_description`, `call_location`, `call_postal`, `call_status`, `call_timestamp`, `call_isPriority`) VALUES
(1, 0, 'PANIC BUTTON HAS BEEN PUSHED Gerald Corrales', 'N/A', '0', 'Archived', '02/08/2021 08:44:50 PM', 'false'),
(2, 0, 'PANIC BUTTON HAS BEEN PUSHED Gerald Corrales', 'N/A', '0', 'Archived', '02/08/2021 08:45:23 PM', 'false');
...
INSERT INTO `characters` (`character_id`, `first_name`, `last_name`, `date_of_birth`, `address`, `height`, `eye_color`, `hair_color`, `sex`, `race`, `weight`, `owner_id`, `owner_name`, `status`, `license_driver`, `license_firearm`) VALUES
(1, 'Blake', 'Cain', '2011-02-07', 'Liverpool rd 3556', '6\'1', 'Green', 'Black', 'M', 'Black', '90', 1, 'xxxgabrilush', 'Enabled', 'None', 'None');
...
INSERT INTO `identities` (`identity_id`, `name`, `department`, `division`, `supervisor`, `created_on`, `user`, `user_name`, `status`) VALUES
(1, 'Gerald Corrales', 'Law Enforcement', 'LSSD', 'Yes', '02/08/2021 08:38:07 PM', 1, 'xxxgabrilush', 'Active');
...
INSERT INTO `logs` (`log_id`, `action`, `username`, `timestamp`) VALUES
(1, 'Started Shift (LEO) - 02/08/2021 08:37:22 PM', 'Gerald Corrales', '02/08/2021 08:37:22 PM'),
(2, 'Started Shift (LEO) - 02/08/2021 08:38:37 PM', 'Gerald Corrales', '02/08/2021 08:38:37 PM'),
(3, 'Started Shift (LEO) - 02/08/2021 08:38:51 PM', 'Gerald Corrales', '02/08/2021 08:38:51 PM'),
(4, 'Started Shift (LEO) - 02/08/2021 08:39:02 PM', 'Gerald Corrales', '02/08/2021 08:39:02 PM'),
(5, 'Started Shift (LEO) - 02/08/2021 08:39:38 PM', 'Gerald Corrales', '02/08/2021 08:39:38 PM'),
(6, 'Started Shift (LEO) - 02/08/2021 08:45:00 PM', 'Gerald Corrales', '02/08/2021 08:45:00 PM'),
(7, 'Started Shift (LEO) - 02/08/2021 08:45:09 PM', 'Gerald Corrales', '02/08/2021 08:45:09 PM'),
(8, 'Started Shift (LEO) - 02/08/2021 08:45:15 PM', 'Gerald Corrales', '02/08/2021 08:45:15 PM'),
(9, 'Logged In', 'xxxgabrilush', '02/08/2021 10:29:06 PM');
...
INSERT INTO `on_duty` (`id`, `name`, `department`, `division`, `status`) VALUES
(10, 'Gerald Corrales', 'Law Enforcement', 'LSSD', 'Off-Duty');
...
(1, 'Server 1', 'Reserve Deputy Sheriff', 0);
...
(1, 'Computer Aided Dispatch / Mobile Data Terminal', 'yes', 'yes', 'false', 'true', 'https://discord.com/api/webhooks/808423154426576906/zRVsOsdUqtxWiufiX89fORW8CGNwt6yT3EtSsYv4B94ulDHCcXpiZWQggTtFDFO84g6Y', 'Europe/Madrid', 'false', 'supervisor', 2, 3, 1);
...
(1, 'Baneado', 'true', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'true'),
(2, 'Sin Verificar', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'true'),
(3, 'Usuario', 'false', 'true', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'true'),
(4, 'Moderador', 'false', 'true', 'true', 'true', 'true', 'false', 'false', 'false', 'false', 'false', 'true'),
...
INSERT INTO `users` (`user_id`, `username`, `password`, `email`, `usergroup`, `join_date`, `join_ip`, `last_ip`, `steam_id`, `avatar`, `failed_logins`, `locked`, `ban_reason`, `root_user`) VALUES
(1, 'xxxgabrilush', '$2y$12$sAlgWV.jEhij2a256IW49uU4.bVtf8cxPA4Ow/GQ1QWoAfaP4sWq2', 'gabrielbasmarquez@gmail.com', 6, '02/08/2021', '::1', NULL, NULL, 'assets/images/users/placeholder.png', 0, NULL, NULL, 'true');
...
--
ALTER TABLE `911calls`
  MODIFY `call_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
